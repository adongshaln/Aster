...
2.5 为故事模式补齐失败重试，并加入完整的 SillyTavern 预设模块：保留文件内默认开关，允许用户逐项选择提示词与 Regex，同时内置 Izumi 周年预设。
...
- 故事回复失败或超时后可直接重新生成；酒馆预设可按原文件默认值配置提示词与 Regex
...
更详细的 2.5.0 变更见 [CHANGELOG.md](CHANGELOG.md#250--2026-09-12)。
